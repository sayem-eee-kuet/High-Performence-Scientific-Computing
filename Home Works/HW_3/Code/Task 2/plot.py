...
data_2 = np.loadtxt('dataParallel_2_b.dat')
...
# Plotting
fig = plt.figure()
plt.loglog(N, err, 'black', label='Error per step: Serial Data',
           marker='o', markerfacecolor='red', markersize=4)
plt.loglog(N, err_1, 'blue', label='Error per step: Parallel Data', marker='o',
...
# plt.show()
fig.savefig("Comparison between serial and parallel.png", bbox_inches="tight")
plt.show()
